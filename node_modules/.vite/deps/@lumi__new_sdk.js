...
// src/node_modules/crypto-js/enc-hex.js
var require_enc_hex = __commonJS({
  "src/node_modules/crypto-js/enc-hex.js"(exports, module) {
    (function(root, factory) {
      if (typeof exports === "object") {
        module.exports = exports = factory(require_core());
      } else if (typeof define === "function" && define.amd) {
...
// src/node_modules/crypto-js/hmac.js
var require_hmac = __commonJS({
  "src/node_modules/crypto-js/hmac.js"(exports, module) {
    (function(root, factory) {
      if (typeof exports === "object") {
        module.exports = exports = factory(require_core());
      } else if (typeof define === "function" && define.amd) {
...
// src/node_modules/crypto-js/hmac-sha256.js
var require_hmac_sha256 = __commonJS({
  "src/node_modules/crypto-js/hmac-sha256.js"(exports, module) {
...
// src/node_modules/object-hash/dist/object_hash.js
var require_object_hash = __commonJS({
  "src/node_modules/object-hash/dist/object_hash.js"(exports, module) {
    !function(e) {
      var t;
      ...
      return function r2(o, i, u2) {
        ...
        !(function(e2, n2, f2, r2, h, p2, g2, y, w2) {
          ...
          H2.Buffer = f2, H2.SlowBuffer = f2, H2.INSPECT_MAX_BYTES = 50, f2.poolSize = 8192, f2._useTypedArrays = function() {
            ...
            var n3 = this.length;
            if (e3 = S2(e3, n3, 0), t2 = S2(t2, n3, n3), f2._useTypedArrays) return f2._augment(this.subarray(e3, t2));
        ...
        !(function(e2, t, n2, r2, u2, s, a2, f2, l) {
          ...
          function o(e3, l2) {
            ...
            for (var r3, o2, h = 0; h < e3.length; h += 16) {
              for (var i2 = t2[0], u3 = t2[1], s2 = t2[2], p2 = t2[3], a3 = t2[4], g2 = t2[5], y = t2[6], w2 = t2[7], f3 = 0; f3 < 64; f3++) n3[f3] = f3 < 16 ? e3[f3 + h] : b2(b2(b2((o2 = n3[f3 - 2], m2(o2, 17) ^ m2(o2, 19) ^ v(o2, 10)), n3[f3 - 7]), (o2 = n3[f3 - 15], m2(o2, 7) ^ m2(o2, 18) ^ v(o2, 3))), n3[f3 - 16]), c3 = b2(b2(b2(b2(w2, m2(o2 = a3, 6) ^ m2(o2, 11) ^ m2(o2, 25)), a3 & g2 ^ ~a3 & y), d2[f3]), n3[f3]), r3 = b2(m2(r3 = i2, 2) ^ m2(r3, 13) ^ m2(r3, 22), i2 & u3 ^ i2 & s2 ^ u3 & s2), w2 = y, y = g2, g2 = a3, a3 = b2(p2, c3), p2 = s2, s2 = u3, u3 = i2, i2 = b2(c3, r3);
...
// src/node_modules/uuid/dist/esm-browser/regex.js
var regex_default = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/i;

// src/node_modules/uuid/dist/esm-browser/validate.js
function validate(uuid) {
  return typeof uuid === "string" && regex_default.test(uuid);
}
var validate_default = validate;

// src/node_modules/uuid/dist/esm-browser/parse.js
function parse(uuid) {
...
// src/node_modules/uuid/dist/esm-browser/stringify.js
var byteToHex = [];
for (let i = 0; i < 256; ++i) {
...
// src/node_modules/uuid/dist/esm-browser/rng.js
var getRandomValues;
...
// src/node_modules/uuid/dist/esm-browser/md5.js
function md5(bytes) {
...
// src/node_modules/uuid/dist/esm-browser/v35.js
...
// src/node_modules/uuid/dist/esm-browser/v3.js
...
// src/node_modules/uuid/dist/esm-browser/native.js
var randomUUID = typeof crypto !== "undefined" && crypto.randomUUID && crypto.randomUUID.bind(crypto);
var native_default = { randomUUID };

// src/node_modules/uuid/dist/esm-browser/v4.js
...
// src/node_modules/uuid/dist/esm-browser/sha1.js
...
// src/node_modules/uuid/dist/esm-browser/v5.js
...
// src/node_modules/@lumi.new/sdk/dist/index.mjs
...
// src/node_modules/destr/dist/index.mjs
...
// src/node_modules/ufo/dist/index.mjs
...
// src/node_modules/ofetch/dist/shared/ofetch.CWycOUEr.mjs
...
// src/node_modules/ofetch/dist/index.mjs
...
var S = (i, e) => {
  for (var t in e || (e = {})) te.call(e, t) && z(i, t, e[t]);
  if (_) for (var t of _(e)) ie.call(e, t) && z(i, t, e[t]);
  return i;
};
var N = (i, e) => W(i, ee(e));
...
function me(i, e) {
  ...
  if (s.length >= 4) throw new b(429, "Too many requests");
  s.push(r2), Y.set(t, s);
}
function c(i, e, t = {}) {
...
var P = class {
  ...
  signIn() {
    if (w) throw new Error("auth.signIn() can only be called on the client side");
  ...
  signOut() {
    if (w) throw new Error("auth.signOut() can only be called on the client side");
  ...
  onAuthChange(e) {
    if (w) throw new Error("auth.onAuthChange() can only be called on the client side");
    let t = (r2) => {
  ...
  list() {
    return m(this, arguments, function* ({ filter: e, sort: t, limit: r2, skip: s } = {}) {
      if (r2) {
        ...
        if (o.code !== 200) throw new Error(o.message);
        return o.data;
      } else {
...
var k = class {
  ...
  send(h) {
    return m(this, arguments, function* ({ to: e, subject: t, fromName: r2, html: s, text: o = "", replyTo: l, scheduledAt: f2 }) {
      if (!e || !t || !s && !o) throw new Error("Failed to send email: Missing required parameters.");
      ...
      if (y.code !== 200) throw new b(y.code, y.message);
    });
  }
};
